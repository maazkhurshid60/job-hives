...
const ApplyCard: React.FC<ApplyCardProps> = ({ job, className }) => {
  ...
  return (
    <aside className={clsx("bg-neutral-0 border border-solid border-neutral-200 rounded-lg p-6 min-[960px]:self-start min-[960px]:sticky min-[960px]:top-[92px] apply-card", className)}>
